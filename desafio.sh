...
cp ./resources/example2/out/salida2.png ./resources/example2/out/salida2.copy.png
mv ./resources/example2/out/salida2.copy.png ./resources/example2/out/salida2.zip
unzip ./resources/example2/out/salida2.zip -d ./resources/example2/out/
